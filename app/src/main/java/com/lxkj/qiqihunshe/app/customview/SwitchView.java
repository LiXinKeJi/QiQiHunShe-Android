package com.lxkj.qiqihunshe.app.customview;
...
public class SwitchView extends View {
    private final int DEFAULT_COLOR_PRIMARY = Color.parseColor("#15acf5");
    private final int DEFAULT_COLOR_PRIMARY_DARK = Color.parseColor("#15acf5");
