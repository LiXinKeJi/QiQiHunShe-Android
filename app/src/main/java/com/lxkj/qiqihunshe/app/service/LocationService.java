...
public class LocationService extends Service {
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            SharePrefUtil.saveString(getApplicationContext(), AppConsts.LAT,location.getLatitude()+"");
            SharePrefUtil.saveString(getApplicationContext(),AppConsts.LNG,location.getLongitude()+"");
        }
    }
