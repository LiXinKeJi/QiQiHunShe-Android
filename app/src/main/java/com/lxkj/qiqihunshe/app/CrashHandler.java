...
//            android.os.Process.killProcess(android.os.Process.myPid());
    ...
    private boolean handleException(Throwable ex) {
        ...
        String filePath = Environment.getExternalStorageDirectory() + "/异常信息/";
        ...
        String Path = filePath + System.currentTimeMillis() + ".txt";
        try {
            //将crash log写入文件
      ...
      /*  //使用Toast来显示异常信息
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
                ToastUtils.showToast(application.getApplicationContext(),"很抱歉,程序出现异常,即将退出");
                Looper.loop();
            }
        }.start();*/
        return true;
