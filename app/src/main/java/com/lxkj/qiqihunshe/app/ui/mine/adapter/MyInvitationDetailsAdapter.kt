...
class MyInvitationDetailsAdapter(val type: Int) :
    BaseListAdapter<MyInvitationDetailsModel, MyInvitationDetailsItemView>() {
    ...
    override fun refreshItemView(view: MyInvitationDetailsItemView, itembean: MyInvitationDetailsModel) {
